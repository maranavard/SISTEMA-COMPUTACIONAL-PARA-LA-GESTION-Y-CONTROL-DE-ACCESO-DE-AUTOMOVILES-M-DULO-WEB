...
# Definir clase base para SQLAlchemy
...
def create_app() -> Flask:
    ...
    # Inicializar SQLAlchemy con Neon PostgreSQL
    ...
    with app.app_context():
        ...
        try:
            ...
            logger.info("✅ Conectado exitosamente a Neon PostgreSQL")
            ...
            logger.info(f"📋 Tablas encontradas en Neon: {len(tables)}")
            ...
            logger.error("Verifica tu variable DATABASE_URL en Render")
